...
public class DomaciJava7sepZAD1GlavnaKlasa {
	...
	public static void main(String[] args) {
		 ...
		 * videa jacinu zvuka kvalitet videa Kreirati apstraktnu klasu Control koja ima:
		 ...
		 * van granica videa. Kreirati klasu AudioControl koja nasledjuje klasu Control
		 ...
		 * pojaca ili smanjuje zvuk za 1. U opsegu od 0 do 100. Kreirati klasu
		 ...
		 * postavlja 720; U glavnom programu kreirati video player i izvrsiti neke
		 * akcije nad njim U glavnom programu kreirati listu akcija i izvrsiti ih nad
		 * istim playerom
		 */
